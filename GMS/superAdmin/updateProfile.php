...
<?php
    ...
    $querys = mysqli_query($con,"select * from tbladmin where adminID='$adminID'");
...
if(isset($_POST['submit'])){
  ...
  $ret=mysqli_query($con,"update tbladmin set firstName='$firstname', 
  emailAddress='$emailAddress', phoneNo='$phoneNo' where adminID='$adminID'");
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="firstname" type="tel" class="form-control cc-exp" value="<?php echo $rrow['firstName'];?>" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
