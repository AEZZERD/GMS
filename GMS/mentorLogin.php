...
error_reporting(0);
    ...
    if(isset($_POST['login']))
    {
        ...
        $query = mysqli_query($con,"select * from tblmentor where mentorID='$mentorID' && password='$password'");
        ...
        if($count > 0)
        {
            ...
            echo "<script type = \"text/javascript\">
                window.location = (\"mentor/index.php\")
               </script>";  
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="Post" Action="">
                            <?php echo $errorMsg; ?>
                        <strong><h2 align="center">Mentor Login</h2></strong><hr>
                        <div class="form-group">
                            <label>Mentor ID</label>
                            <input type="text" name="mentorID" Required class="form-control" placeholder="mentorID">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="checkbox">
                           <label class="pull-left">
                            ...
                            <label class="pull-right">
                                <a href="#"> </a><!-- Log on to codeastro.com for more projects! -->
                            </label>
                        </div>
